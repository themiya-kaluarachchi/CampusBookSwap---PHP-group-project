<div class="max-w-7xl mx-auto p-6 bg-white rounded-lg shadow border-gray-200">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition">
      ...
      <div class="p-4">
        <h3 class="text-md font-semibold text-gray-900">Calculus: Early Transcendentals</h3>
        <p class="text-sm text-gray-500 mb-1">by James Stewart</p>
        <div class="flex items-center justify-between mt-2">
          <span class="text-blue-600 font-bold text-lg">$80</span>
          <span class="text-xs px-2 py-1 bg-gray-200 rounded-full">New</span>
        </div>
    ...
    <!-- You can duplicate this card structure for more books -->
